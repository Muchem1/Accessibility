...
lamu.all.hf.01 <- st_read("/Users/annekariithi/Documents/Accessibility/lamu_county/L_Hf.shp")  
lamu.all.hf <- st_transform(lamu.all.hf.01, crs = 4326)

# Read administrative boundaries for Lamu County
lamu.01 <- st_read("/Users/annekariithi/Documents/Accessibility/lamu_county/L_Bndry.shp")
lamu <- st_transform(lamu.01, crs = 4326)

# Load population raster for Lamu
lamu.pop <- raster("/Users/annekariithi/Documents/Accessibility/lamu_county/L_Pop.tif")
...
for (i in 1:nrow(lamu.all.hf)) {
  ...
  travel_time_categories <- cut(values(access_raster_spat),
                                 ...
                                 labels = c("0-30", "31-60", "61-120", "121-180"),
                                 right = TRUE)
  ...
  output_file_path <- paste0("/Users/annekariithi/Documents/Accessibility/lamu2_output/catchment_area_",lamu.all.hf$code[i], ".shp") 
...
output_csv_path <- "/Users/annekariithi/Documents/Accessibility/lamu_county/lamu_outputdissolved_catchment_areas_by_category.csv"
